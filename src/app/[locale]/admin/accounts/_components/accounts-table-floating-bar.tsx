...
import { deleteAccounts, updateAccounts } from "../_lib/actions"
...
export function AccountsTableFloatingBar({
  ...
  const [method, setMethod] = React.useState<
    "update-account-type" | "export" | "delete"
  >()
      ...
      <div className="w-full overflow-x-auto">
        <div className="mx-auto flex w-fit items-center gap-2 rounded-md border bg-card p-2 shadow-2xl">
          ...
          <div className="flex items-center gap-1.5">
            <Select
              onValueChange={(value: Account["accountType"]) => {
                setMethod("update-account-type")

                startTransition(async () => {
                  const { error } = await updateAccounts({
                ...
                <SelectTrigger asChild>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      disabled={isPending}
                    >
                      {isPending && method === "update-account-type" ? (
                        <ReloadIcon
